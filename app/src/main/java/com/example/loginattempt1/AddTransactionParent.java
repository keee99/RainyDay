...
public class AddTransactionParent extends ParentAbstractActivity {

    private final String TAG = "AddTransactionParent";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_transaction_p);
        ...
        Home.setOnClickListener(new View.OnClickListener (){
            public void onClick(View v){
                Intent intent = new Intent(AddTransactionParent.this,HomeParentActivity.class);
    ...
    private void recordTransaction (
            ...
            String Item)
    {
        Transaction ok = new Transaction.Builder()
        ...
        ok.update(new FirebaseCallback() {
            ...
            public void onResponse(Map<String, Object> documents) {
                ...
                Toast.makeText(AddTransactionParent.this,
                        "Transaction Added!",
                        Toast.LENGTH_LONG)
                        .show();
